...
const EventCard = ({ event }) => {
  ...
  return (
    <button type="button" className="h-40 border-0 transform hover:scale-105 transition duration-00 ease-in outline-none shadow max-w-sm w-full active:outline-none active:border-0 bg-indigo-600 rounded-xl relative flex flex-col">
